...
class RefundlistController extends AdminbaseController {
    ...
    function edit(){
        ...
        $data['platform_handle_desc']=$platform_info['handle_desc'] ?? '';
    ...
    function editPost(){
        if ($this->request->isPost()){
            ...
            if($platform_result==1){ //平台同意退款
                ...
                $title_en="The refund initiated by your product ".$order_info['goods_name']." has been approved by the platform.";
                ...
                txMessageIM(json_encode($im_msg),$order_info['uid'],'goodsorder_admin','TIMCustomElem');

                //给卖家发送消息
                $title1="买家商品“".$order_info['goods_name']."”发起的退款,平台已同意退款";
                $title1_en="The refund initiated by the buyer's product ".$order_info['goods_name']." has been approved by the platform";
                ...
                $title_en="The refund initiated by your product ".$order_info['goods_name']." has been rejected by the platform";
                ...
                $title1_en="The refund initiated by the buyer's product ".$order_info['goods_name']." has been rejected by the platform";
    ...
    public function platformeditPost(){
        ...
        if($type==0){ //拒绝
            ...
            $title_en="The seller of your item ".$order_info['goods_name']." refuses to refund";
            ...
            $title_en="The seller of your product ".$order_info['goods_name']." has agreed to refund";
