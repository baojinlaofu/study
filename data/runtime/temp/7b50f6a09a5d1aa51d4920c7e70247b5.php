<?php /*a:1:{s:83:"/www/wwwroot/xiangqu8.com/public/../themes/admin_simpleboot3/admin/index/index.html";i:1733460857;}*/ ?>
<!DOCTYPE html>
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
            ...
            <ul class="nav navbar-nav navbar-right simplewind-nav">
				...
				<li class="light-blue" style="border-left:none;">
					...
					<a class="btn btn-sm"	style="color:#fff;font-size: 16px"
				...
				<?php if(APP_DEBUG): ?>
					<li class="light-blue" style="border-left:none;" data-toggle="tooltip">
						<a class="btn btn-sm" style="color:#fff;font-size: 16px"
...
<div class="main-container container-fluid">
    ...
    <div class="sidebar" id="sidebar">
        <!--<div class="sidebar-shortcuts" id="sidebar-shortcuts">
            ...
            <?php endif; if(cmf_auth_check(cmf_get_current_admin_id(),'user/AdminAsset/index')): ?>
