<?php /*a:3:{s:89:"/www/wwwroot/xiangqu8.com/public/../themes/admin_simpleboot3/admin/setting/configpri.html";i:1733460871;s:79:"/www/wwwroot/xiangqu8.com/public/../themes/admin_simpleboot3/public/header.html";i:1733460547;s:79:"/www/wwwroot/xiangqu8.com/public/../themes/admin_simpleboot3/public/active.html";i:1733460547;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="C">
                        ...
                        <div class="form-group" style="display:none;">
                            <label for="input-cdn_switch" class="col-sm-2 control-label">选择推拉流服务商</label>
                            <div class="col-md-6 col-sm-10" id="cdn">
                                <label class="radio-inline"><input type="radio" value="1" name="options[cdn_switch]" <?php if(in_array(($config['cdn_switch']), explode(',',"1"))): ?>checked="checked"<?php endif; ?>>腾讯云</label>
                                <label class="radio-inline"><input type="radio" value="2" name="options[cdn_switch]" <?php if(in_array(($config['cdn_switch']), explode(',',"2"))): ?>checked="checked"<?php endif; ?>>声网</label>
                        ...
                        <div class="cdn_bd <?php if($config['cdn_switch'] != '2'): ?>cdnhide<?php endif; ?>" id="cdn_switch_2">
                            ...
                            <div class="form-group">
                                <label for="input-sw_app_id" class="col-sm-2 control-label">声网APP ID</label>
                                <div class="col-md-6 col-sm-10">
                                    <input type="text" class="form-control" id="input-sw_app_id" name="options[sw_app_id]" value="<?php echo (isset($config['sw_app_id']) && ($config['sw_app_id'] !== '')?$config['sw_app_id']:''); ?>">
                                    <p class="help-block">声网控制台==》右上角用户头像下拉框==》项目管理==》项目==》APP ID</p>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="input-sw_media_region" class="col-sm-2 control-label">媒体流源站所在地区</label>
                                <div class="col-md-6 col-sm-10">
                                    <label class="radio-inline"><input type="radio" value="cn" name="options[sw_media_region]" <?php if(in_array(($config['sw_media_region']), explode(',',"cn"))): ?>checked="checked"<?php endif; ?>>中国大陆</label>
                                    <label class="radio-inline"><input type="radio" value="ap" name="options[sw_media_region]" <?php if(in_array(($config['sw_media_region']), explode(',',"ap"))): ?>checked="checked"<?php endif; ?>>中国大陆外亚洲地区</label>
                                    <label class="radio-inline"><input type="radio" value="na" name="options[sw_media_region]" <?php if(in_array(($config['sw_media_region']), explode(',',"na"))): ?>checked="checked"<?php endif; ?>>北美</label>
                                    <label class="radio-inline"><input type="radio" value="eu" name="options[sw_media_region]" <?php if(in_array(($config['sw_media_region']), explode(',',"eu"))): ?>checked="checked"<?php endif; ?>>欧洲</label>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="input-sw_app_certificate" class="col-sm-2 control-label">声网APP主要证书</label>
                                <div class="col-md-6 col-sm-10">
                                    <input type="text" class="form-control" id="input-sw_app_certificate" name="options[sw_app_certificate]" value="<?php echo (isset($config['sw_app_certificate']) && ($config['sw_app_certificate'] !== '')?$config['sw_app_certificate']:''); ?>">
                                    <p class="help-block">声网控制台==》总览==》APP证书==》主要证书</p>
                                </div>
                            </div>
                            

                            <div class="form-group">
                                <label for="input-sw_key_id" class="col-sm-2 control-label">声网客户ID/Key</label>
                                <div class="col-md-6 col-sm-10">
                                    <input type="text" class="form-control" id="input-sw_key_id" name="options[sw_key_id]" value="<?php echo (isset($config['sw_key_id']) && ($config['sw_key_id'] !== '')?$config['sw_key_id']:''); ?>">
                                    <p class="help-block">声网控制台==》右上角用户头像下拉框==》RESTful API==》客户ID/Key</p>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="input-sw_key_secret" class="col-sm-2 control-label">声网客户密钥/Secret</label>
                                <div class="col-md-6 col-sm-10">
                                    <input type="text" class="form-control" id="input-sw_key_secret" name="options[sw_key_secret]" value="<?php echo (isset($config['sw_key_secret']) && ($config['sw_key_secret'] !== '')?$config['sw_key_secret']:''); ?>">
                                    <p class="help-block">声网控制台==》右上角用户头像下拉框==》RESTful API==》客户密钥/Secret</p>
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label for="input-sw_push_url" class="col-sm-2 control-label">推流域名</label>
                                <div class="col-md-6 col-sm-10">
                                    <input type="text" class="form-control" id="input-sw_push_url" name="options[sw_push_url]" value="<?php echo (isset($config['sw_push_url']) && ($config['sw_push_url'] !== '')?$config['sw_push_url']:''); ?>"> 
                                    <p class="help-block">不带http(s):// 声网控制台==》全部产品==》基础能力==》融合CDN直播==》功能配置==》融合CDN==》推流域名</p>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="input-sw_push_key" class="col-sm-2 control-label">推流防盗链密钥</label>
                                <div class="col-md-6 col-sm-10">
                                    <input type="text" class="form-control" id="input-sw_push_key" name="options[sw_push_key]" value="<?php echo (isset($config['sw_push_key']) && ($config['sw_push_key'] !== '')?$config['sw_push_key']:''); ?>"> 
                                    <p class="help-block">声网控制台==》全部产品==》基础能力==》融合CDN直播==》功能配置==》融合CDN==》推流防盗链密钥</p>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="input-sw_push_length" class="col-sm-2 control-label">推流鉴权有效时长</label>
                                <div class="col-md-6 col-sm-10">
                                    <input type="text" class="form-control" id="input-sw_push_length" name="options[sw_push_length]" value="<?php echo (isset($config['sw_push_length']) && ($config['sw_push_length'] !== '')?$config['sw_push_length']:'5'); ?>"> 
                                    <p class="help-block">最小为1分钟（分钟）,超出该分钟数，推流将失败,请合理设置,默认5分钟</p>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="input-sw_pull_url" class="col-sm-2 control-label">播流域名</label>
                                <div class="col-md-6 col-sm-10">
                                    <input type="text" class="form-control" id="input-sw_pull_url" name="options[sw_pull_url]" value="<?php echo (isset($config['sw_pull_url']) && ($config['sw_pull_url'] !== '')?$config['sw_pull_url']:''); ?>"> 
                                    <p class="help-block">不带http(s):// 声网控制台==》全部产品==》基础能力==》融合CDN直播==》功能配置==》融合CDN==》播流域名</p>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="input-sw_pull_key" class="col-sm-2 control-label">播流防盗链密钥</label>
                                <div class="col-md-6 col-sm-10">
                                    <input type="text" class="form-control" id="input-sw_pull_key" name="options[sw_pull_key]" value="<?php echo (isset($config['sw_pull_key']) && ($config['sw_pull_key'] !== '')?$config['sw_pull_key']:''); ?>"> 
                                    <p class="help-block">声网控制台==》全部产品==》基础能力==》融合CDN直播==》功能配置==》融合CDN==》播流防盗链密钥</p>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="input-sw_pull_length" class="col-sm-2 control-label">播流鉴权有效时长</label>
                                <div class="col-md-6 col-sm-10">
                                    <input type="text" class="form-control" id="input-sw_pull_length" name="options[sw_pull_length]" value="<?php echo (isset($config['sw_pull_length']) && ($config['sw_pull_length'] !== '')?$config['sw_pull_length']:'5'); ?>"> 
                                    <p class="help-block">最小为1分钟（分钟）,超出该分钟数，播流将失败,请合理设置,默认5分钟</p>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane" id="E">
                        ...
                        <div class="form-group">
                            <label for="input-tencentIM_area" class="col-sm-2 control-label">腾讯云IM APPID所在国家/地区</label>
                            <div class="col-md-6 col-sm-10">
                                <label class="radio-inline"><input type="radio" value="china" name="options[tencentIM_area]" <?php if(in_array(($config['tencentIM_area']), explode(',',"china"))): ?>checked="checked"<?php endif; ?>>中国</label>
                                <label class="radio-inline"><input type="radio" value="singapore" name="options[tencentIM_area]" <?php if(in_array(($config['tencentIM_area']), explode(',',"singapore"))): ?>checked="checked"<?php endif; ?>>新加坡</label>
                                <label class="radio-inline"><input type="radio" value="seoul" name="options[tencentIM_area]" <?php if(in_array(($config['tencentIM_area']), explode(',',"seoul"))): ?>checked="checked"<?php endif; ?>>首尔</label>
                                <label class="radio-inline"><input type="radio" value="frankfurt" name="options[tencentIM_area]" <?php if(in_array(($config['tencentIM_area']), explode(',',"frankfurt"))): ?>checked="checked"<?php endif; ?>>法兰克福</label>
                                <label class="radio-inline"><input type="radio" value="bombay" name="options[tencentIM_area]" <?php if(in_array(($config['tencentIM_area']), explode(',',"bombay"))): ?>checked="checked"<?php endif; ?>>孟买</label>
                                <label class="radio-inline"><input type="radio" value="silicon-valley" name="options[tencentIM_area]" <?php if(in_array(($config['tencentIM_area']), explode(',',"silicon-valley"))): ?>checked="checked"<?php endif; ?>>硅谷</label>
                                <label class="radio-inline"><input type="radio" value="jakarta" name="options[tencentIM_area]" <?php if(in_array(($config['tencentIM_area']), explode(',',"jakarta"))): ?>checked="checked"<?php endif; ?>>雅加达</label>

                                <p class="help-block">确保配置同腾讯云IM控制台创建的应用区域一致，否则推送将失败</p>
                            </div>
                        </div>
