<?php /*a:3:{s:85:"/www/wwwroot/xiangqu8.com/public/../themes/admin_simpleboot3/admin/sticker/index.html";i:1733460874;s:79:"/www/wwwroot/xiangqu8.com/public/../themes/admin_simpleboot3/public/header.html";i:1733460547;s:79:"/www/wwwroot/xiangqu8.com/public/../themes/admin_simpleboot3/public/active.html";i:1733460547;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a>贴纸列表</a></li>
            <li><a href="<?php echo url('Sticker/add'); ?>"><?php echo lang('ADD'); ?></a></li>
		</ul>
		<form method="post" class="js-ajax-form" action="<?php echo url('Sticker/listOrder'); ?>">
				...
				<tbody>
					...
					<tr>
					   <td><input name="list_orders[<?php echo $vo['id']; ?>]" class="input-order" type="text" value="<?php echo $vo['list_order']; ?>"></td>
                        ...
                        <td><?php echo $vo['sticker_id']; ?></td>
                        <td><?php echo $vo['swftime']; ?></td>
						<td><?php echo date('Y-m-d H:i',$vo['addtime']); ?></td>
						<td>
                            <a class="btn btn-xs btn-primary" href='<?php echo url("Sticker/edit",array("id"=>$vo["id"])); ?>'><?php echo lang('EDIT'); ?></a>
							<a class="btn btn-xs btn-danger js-ajax-delete" href="<?php echo url('Sticker/del',array('id'=>$vo['id'])); ?>"><?php echo lang('DELETE'); ?></a>
						</td>
					</tr>
