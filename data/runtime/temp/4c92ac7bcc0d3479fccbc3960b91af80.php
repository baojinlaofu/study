<?php /*a:3:{s:88:"/www/wwwroot/xiangqu8.com/public/../themes/admin_simpleboot3/admin/liverecord/index.html";i:1733460861;s:79:"/www/wwwroot/xiangqu8.com/public/../themes/admin_simpleboot3/public/header.html";i:1733460547;s:79:"/www/wwwroot/xiangqu8.com/public/../themes/admin_simpleboot3/public/active.html";i:1733460547;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		...
		<form class="well form-inline margin-top-20" method="post" action="<?php echo url('liverecord/index'); ?>">
            时间：
			<input class="form-control js-bootstrap-date" autocomplete="off" name="start_time" id="start_time" value="<?php echo input('request.start_time'); ?>" aria-invalid="false" style="width: 110px;"> - 
            <input class="form-control js-bootstrap-date" autocomplete="off" name="end_time" id="end_time" value="<?php echo input('request.end_time'); ?>" aria-invalid="false" style="width: 110px;">
			会员ID： 
