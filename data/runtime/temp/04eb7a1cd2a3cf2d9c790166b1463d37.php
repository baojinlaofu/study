<?php /*a:5:{s:79:"/www/wwwroot/xiangqu8.com/public/../themes/default/home/category/classlive.html";i:1733451420;s:67:"/www/wwwroot/xiangqu8.com/public/../themes/default/public/head.html";i:1733451414;s:69:"/www/wwwroot/xiangqu8.com/public/../themes/default/public/header.html";i:1733451414;s:69:"/www/wwwroot/xiangqu8.com/public/../themes/default/public/footer.html";i:1733451414;s:70:"/www/wwwroot/xiangqu8.com/public/../themes/default/public/scripts.html";i:1733451414;}*/ ?>
<!DOCTYPE html>
<!--[if lt IE 7]>
...
<title><?php echo $site_seo_title; ?> - <?php echo $configpub['site_name']; ?></title>

<link type="text/css" rel="stylesheet" href="/static/home/css/index.css"/>
<link type="text/css" rel="stylesheet" href="/static/home/css/classlive.css"/>
<style type="text/css">
	.feed-list .feed{
		height: 310px;
	}
			...
			<div class="main clearfix">
				...
				<div class="g-box feed-list" >
						...
						<ul class="class_list">
							...
							<a href="/home/Category/classlive/cat/classlive/classid/0">
								<li <?php if(!$classid): ?>class="current"<?php endif; ?>>全部</li>
							</a>
							<?php if(is_array($live_class) || $live_class instanceof \think\Collection || $live_class instanceof \think\Paginator): if( count($live_class)==0 ) : echo "" ;else: foreach($live_class as $key=>$vo): ?>
							<a href="/home/Category/classlive/cat/classlive/classid/<?php echo $vo['id']; ?>">
								<li <?php if($vo['id'] == $classid): ?>class="current"<?php endif; ?>><?php echo $vo['name']; ?></li>
							</a>
					...
					<div class="box-bd">
						<ul class="list">
							...
							<li class="feed <?php if($v['islive'] == '1'): ?>live<?php else: ?><?php endif; ?> "><a class="link" href="/<?php echo $v['uid']; ?>" target="_blank"><img class="screenshot thumb" src="/static/home/images/lazyload.png" data-original="<?php echo get_upload_path($v['thumb']); ?>"/>
							<div class="user">
								<div class="user_left fl"><img class="avatar thumb" src="/static/home/images/lazyload.png" data-original="<?php echo get_upload_path($v['avatar']); ?>"/></div>
								<div class="user_right fl">
									<p class="username"><?php echo $v['user_nickname']; ?></p>
									<p class="bottom">
