var JsInterface={
	...
	chatFromSocket: function(data) {
		...
		}else if(msgmethod=='ConnectVideo'){ //用户和主播连麦
    ...
    liveConnect:function(data){
        ...
        if(_DATA.cdn_switch==2 && (_DATA.live.uid != _DATA.user.id)){
        	...
        	if(action==4){
		        ...
		        $.ajax({
		        	url:'/home/show/getLinkMicSwRtcToken',
		        	type:'post',
		        	...
		        	success:function(data){
		        		...
		        		try{
		        			...
		        			var player_area_height=$("#LF-area-video").height();
		        			$("#player-"+_DATA.live.uid).height(player_area_height/2);
